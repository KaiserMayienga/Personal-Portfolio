    ...
    <div className="font-sans">
      ...
      <main id="home" className="p-8 pt-28 bg-gray-50 min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <a href="#projects">
            <motion.button
              className="px-6 py-3 bg-blue-600 text-white rounded-xl text-md font-medium hover:bg-blue-700 transition"
      ...
      <section id="contact" className="bg-blue-50 py-16 px-6 md:px-20">
        ...
        <form className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow space-y-6">
          <div>
            ...
            <input type="text" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500" placeholder="Your Name" />
          </div>
          <div>
            <label className="block text-gray-700 font-medium mb-2">Email</label>
            <input type="email" className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500" placeholder="your@email.com" />
          </div>
          <div>
            <label className="block text-gray-700 font-medium mb-2">Message</label>
            <textarea className="w-full border border-gray-300 rounded-lg px-4 py-2 h-32 resize-none focus:outline-none focus:border-blue-500" placeholder="Write your message..." />
          </div>
      ...
      <footer className="bg-white py-6 px-8 text-center border-t border-gray-200">
        ...
        <p className="text-sm text-gray-400">© {new Date().getFullYear()} Caesar Mayienga. All rights reserved.</p>
      </footer>
    </div>
  );
}
